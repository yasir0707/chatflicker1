...
export declare class MdbAccordionItemComponent implements OnInit {
    ...
    onShown(): void;
    onHidden(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<MdbAccordionItemComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<MdbAccordionItemComponent, "mdb-accordion-item", never, { "id": "id"; "collapsed": "collapsed"; "header": "header"; }, { "itemShow": "itemShow"; "itemShown": "itemShown"; "itemHide": "itemHide"; "itemHidden": "itemHidden"; }, ["_headerTemplate", "_bodyTemplate"], never>;
}
